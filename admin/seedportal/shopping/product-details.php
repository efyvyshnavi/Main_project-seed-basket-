...
if(isset($_GET['action']) && $_GET['action']=="add"){
	...
	if(isset($_SESSION['cart'][$pid])){
		...
		$sql_p="SELECT * FROM tbl_product WHERE pid={$id}";
		$query_p=mysqli_query($con,$sql_p);
		if(mysqli_num_rows($query_p)!=0){
			$row_p=mysqli_fetch_array($query_p);
			$_SESSION['cart'][$row_p['pid']]=array("quantity" => 1, "price" => $row_p['price2']);
...
<div class="sidebar-widget hot-deals wow fadeInUp">
	...
	<div class="owl-carousel sidebar-carousel custom-carousel owl-theme outer-top-xs">
								   ...
								   <?php
$ret=mysqli_query($con,"select * from tbl_product order by rand() limit 4 ");
...
?>
					...
					<div class="products">
						<div class="hot-deal-wrapper">
							<div class="image">
								<a href="product-details.php?pid=<?php echo htmlentities($rws['pid']);?>"><img  src="assets/images/blank.gif" data-echo="admin/productimages/<?php echo htmlentities($rws['catid']);?>/<?php echo htmlentities($rws['pimage']);?>" alt="" width="200" height="200"></a>
							</div>
							
						</div><!-- /.hot-deal-wrapper -->

						<div class="product-info text-left m-t-20">
							<h3 class="name"><a href="product-details.php?pid=<?php echo htmlentities($rws['pid']);?>"><?php echo htmlentities($rws['pname']);?></a></h3>
							...
							<div class="product-price">	
							    ...
							    <span class="price-before-discount">Rs.<?php echo htmlentities($rws['price1']);?></span>					
...
?>
 ...
 <div class="single-product-gallery-item" id="slide1">
                <a data-lightbox="image-1" data-title="<?php echo htmlentities($row['pid']);?>" href="admin/productimages/<?php echo htmlentities($row['catid']);?>/<?php echo htmlentities($row['pimage']);?>">
                    <img class="img-responsive" alt="" src="assets/images/blank.gif" data-echo="admin/productimages/<?php echo htmlentities($row['pid']);?>/<?php echo htmlentities($row['pimage']);?>" width="370" height="350" />
                </a>
            </div>
