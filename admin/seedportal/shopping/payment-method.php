...
if (isset($_POST['sub'])) {
	...
	mysqli_query($con,"insert into orders (cart_id,total,paymentMethod,status) VALUES ('$cartid','$tp','".$_POST['paymethod']."','1')");
	echo "<script>
		window.href=location='payment-method.php';
	</script>"; 
...
<div id="collapseOne" class="panel-collapse collapse in">
	...
	<div class="panel-body">
		...
		<!-- panel-body  -->
<button class="btn btn-primary"style = "position:relative;left:420px;top:-45px;background:#abd07e;color:white;font-size:16px;"id="myBtn">CONFIRM AND PROCEED TO PAYMENT</button>
...
<form action="#" method="post">
      <div class="cardStyle">
		...
		<div class="inputDiv">
		 <b> <td><p style="font-family:Arial;font-size:20px">select payment method</p></td>
...
<input class="btn btn-primary" style="background-color:#abd07e" type="submit" name="sub" id="input1" value="PAY NOW"/>
