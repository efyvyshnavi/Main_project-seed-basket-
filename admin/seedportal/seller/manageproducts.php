...
<?php 
$query=mysqli_query($conn,"select tbl_product.pname,tbl_product.creationDate,tbl_product.updationDate,tbl_product.pid,tbl_product.status,tbl_category.categoryName,tbl_subcategory.subcategory from tbl_product join tbl_category on tbl_category.catid=tbl_product.catid join tbl_subcategory on tbl_subcategory.subid=tbl_product.subid");
...
?>									
            ...
            <td>
                        ...
                        <?php
                        if($row['status']==1){
                          echo '<p><a href="pinactivate.php?id='.$row['pid'].'$status=1">Disable</a></p>';
                        }else{
                          echo '<p><a href="pactivate.php?id='.$row['pid'].'$status=0">Enable</a></p>';
                        }
                        ?>
            </td>
				<td><a href="edit-product.php">Edit</a></td>
