...
if(isset($_POST['send_otp'])){
    ...
    if($rsltCheck>0){
        ...
        $mail->Username   = 'vyshnavibabus2023b@mca.ajce.in';                     //SMTP username
        $mail->Password   = 'vyshnavi@123';                               //SMTP password
        $mail->SMTPSecure = 'ssl';            //Enable implicit TLS encryption
        $mail->Port       = 465;                                    //TCP port to connect to; use 587 if you have set `SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS`
        

        //Recipients
        $mail->setFrom('vyshnavibabus2023b@mca.ajce.in');
...
<body>
<div class="navbar">
<a class="left" href="login.php"><img src="http://www.clker.com/cliparts/D/u/b/H/5/b/login-button-png.svg" alt="" width="300" height="90"></a>
    </div>
