...
form.example::after {
  ...
  display: table;
	...
	<br>
	  ...
	  <a href="#"class="icon-a"style="color:black;"><i class="fa fa-list-alt icons"></i>   Sellers Details</a>
...
<?php $query=mysqli_query($conn,"select sellerreg.sellerid,sellerreg.fname,sellerreg.lname,login.email,sellerreg.phoneno,sellerreg.logid,sellerreg.status,sellerreg.creationDate from sellerreg join login on login.logid=sellerreg.logid");
$cnt=1;
